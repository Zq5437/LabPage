<template>
  <div class="admin-header">
    <div class="header-left">
      <!-- 侧边栏切换按钮 -->
      <el-button type="text" class="sidebar-toggle" @click="$emit('toggle-sidebar')">
        <el-icon size="18">
    ...
    <div class="header-right">
      ...
      <div class="quick-actions">
        ...
        <el-tooltip content="访问前台网站" placement="bottom">
          <el-button type="text" class="action-btn" @click="openFrontSite">
            <el-icon size="18">
              <Monitor />
            </el-icon>
          </el-button>
        ...
        <el-tooltip content="刷新页面" placement="bottom">
          <el-button type="text" class="action-btn" @click="refreshPage">
            <el-icon size="18">
              <Refresh />
            </el-icon>
          </el-button>
    ...
    <!-- 修改密码对话框 -->
    <ChangePasswordDialog v-model:visible="passwordDialogVisible" @success="handlePasswordChanged" />
  </div>
</template>
...
const loadSiteConfig = async () => {
  try {
    ...
    const url = data.front_site_url || '/'
    frontSiteUrl.value = typeof url === 'string' && url.trim() ? url.trim() : '/'
  } catch (e) {
    frontSiteUrl.value = '/'
  }
}
